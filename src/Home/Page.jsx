...
import articles from './articles.yaml'
  ...
  return <Container>
    <Box sx={{display: 'flex', flexFlow: 'row', mt: '2rem'}}>
      <Box>
        <Container>
          <h1 sx={{}}>
            {t('HOME.IS_IT_WORTH_TITLE1')}<br/>
            {t('HOME.IS_IT_WORTH_TITLE2')}<br/>
          </h1>
          <p>{t('HOME.IS_IT_WORTH_PARAGRAPH1')}</p>
          <p>{t('HOME.IS_IT_WORTH_PARAGRAPH2')}</p>
          <Button variant='contained' href="#tools">{t('HOME.IS_IT_WORTH_BUTTON')}</Button>
        </Container>
      </Box>
      <img src="/logo.svg" style={{objectFit: 'contain', minWidth: '100px', width: '50%'}} />
    </Box>
    <Box sx={{display: 'flex', flexFlow: 'column', my: '2rem'}} style={{alignItems: 'center'}}>
      <h1>
        <a name="tools"/>
        {t('HOME.SIMULATION_TOOLS_TITLE')}
      </h1>
      <Box sx={{width: '100%', display: 'flex', flexFlow: 'row wrap', justifyContent: 'center', gap: '5%'}}>
        <ToolSelector
          route="/simulator"
    ...
    <Box>
      <Container sx={{display: 'flex', flexFlow: 'column', mt: '2rem', alignItems: 'center'}}>
        <h1 sx={{}}>
