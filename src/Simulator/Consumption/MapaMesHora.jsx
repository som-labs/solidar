...
const MapaMesHora = ( tconsumo ) => {
    ...
    return <>
    <Container>
        <Typography variant='h4'>{t("CONSUMPTION.TITLE_MAP_MONTH_HOUR", {nombreTipoConsumo: consumo.nombreTipoConsumo})}</Typography>
        ...
        layout = {{
            ...
            annotations: [
                ...
                axref: 'x', ayref: 'y',
                xref: 'x', yref: 'y',
                text: TCB.i18next.t('graficos_LBL_maxConsumoMes', {maxConsumoMes: maxConsumoMes.toFixed(2)}),
                showarrow: true,
                arrowhead: 3,
                xanchor: 'center',
                ax: 12,
