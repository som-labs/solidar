                ...
                <div>
                  ...
                  <ul style={styles.list}>
                    <li style={styles.listitem}>
                      {t('REPORT.DADES_NOM')}:{' '}
                      <strong>{'data.contract.owner_name'}</strong>
                    </li>
                    <li style={styles.listitem}>
              ...
              <div style={styles.dades}>
                ...
                <ul style={styles.list}>
                  <li style={styles.listitem}>
                    ...
                    <strong>
                      {UTIL.formatoValor('angulo', TCB.BaseSolar[0].inAcimut)}
                    </strong>
                  </li>
                  <li style={styles.listitem}>
                    {t('REPORT.COBERTA_INCLINACIO')}:{' '}
                    <strong>
                      {UTIL.formatoValor('angulo', TCB.BaseSolar[0].inclinacion)}
                    </strong>
                  </li>
                  <li style={styles.listitem}>
                    {t('REPORT.COBERTA_SUPERFICIE')}:{' '}
                    <strong>
                      {UTIL.formatoValor('superficie', TCB.BaseSolar[0].areaReal)}
                    </strong>
                  </li>
                </ul>
